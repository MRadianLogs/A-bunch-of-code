	...
	public static void main(String[] args)
	{
		...
		while(quit!= true)
		{
			...
			catch(InputMismatchException e)
			{
				...
				{
					//Is there a way to do a while loop try catch? So that the user cannot enter an incorrect type again?
					input.nextLine();
					System.out.print("\nPlease choose a Math topic to practice(Enter 1 through 5!): ");
					userChoice = input.nextInt();
				}
			}
