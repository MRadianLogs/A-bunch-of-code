...
public class ControllableParticleWrapBounds extends ControllableParticle
{
	...
	public ControllableParticleWrapBounds(Game game, double xPos, double yPos, Color particleColor, double particleDiameter, int upButton, int downButton, int leftButton, int rightButton) 
	{
